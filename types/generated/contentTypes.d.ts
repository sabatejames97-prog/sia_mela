...
export interface ApiMedicineMedicine extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    batch: Schema.Attribute.Component<'batch.batch', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    is_prescription: Schema.Attribute.Media<
    ...
    > &
      Schema.Attribute.Private;
    medicine_desc: Schema.Attribute.Text & Schema.Attribute.Required;
    medicine_name: Schema.Attribute.String & Schema.Attribute.Required;
    medicine_type: Schema.Attribute.Enumeration<
      ['tablet', 'capsule', 'syrup', 'injectable', 'inhaler', 'drops']
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSaleSale extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    batchNumber: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiSupplierSupplier extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ContactPerson: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    EmailAddress: Schema.Attribute.Email;
    LicenseNumber: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    SupplierName: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
